...
resource "aws_vpc_endpoint" "ssm" {
  ...
  tags = {
    Name = "${var.resource_name_prefix}-vault-ssm-endpoint"
  }
}
...
resource "aws_vpc_endpoint" "ssmmessages" {
  ...
  tags = {
    Name = "${var.resource_name_prefix}-vault-ssmmessages-endpoint"
  }
}
...
resource "aws_vpc_endpoint" "ec2messages" {
  ...
  tags = {
    Name = "${var.resource_name_prefix}-vault-ec2messages-endpoint"
  }
}
